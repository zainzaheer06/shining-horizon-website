        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-3">
                ...
                <nav class="hidden lg:flex items-center gap-8">
                    <a href="index.html" class="text-gray-600 hover:text-primary transition font-medium text-sm">Home</a>
                    <a href="index.html#about" class="text-gray-600 hover:text-primary transition font-medium text-sm">About</a>
                    <a href="categories.html" class="text-gray-600 hover:text-primary transition font-medium text-sm">Categories</a>
                    <a href="index.html#products" class="text-gray-600 hover:text-primary transition font-medium text-sm">Products</a>
                    <a href="index.html#services" class="text-gray-600 hover:text-primary transition font-medium text-sm">Services</a>
                    <a href="index.html#contact" class="text-gray-600 hover:text-primary transition font-medium text-sm">Contact</a>
                </nav>
        ...
        <div id="mobile-menu" class="lg:hidden fixed inset-0 bg-white z-50 transform translate-x-full transition-transform duration-300">
            <div class="p-6">
                ...
                <nav class="flex flex-col gap-6">
                    <a href="index.html" class="text-xl font-semibold text-gray-700 hover:text-primary">Home</a>
                    <a href="index.html#about" class="text-xl font-semibold text-gray-700 hover:text-primary">About</a>
                    <a href="categories.html" class="text-xl font-semibold text-gray-700 hover:text-primary">Categories</a>
                    <a href="index.html#products" class="text-xl font-semibold text-gray-700 hover:text-primary">Products</a>
                    <a href="index.html#services" class="text-xl font-semibold text-gray-700 hover:text-primary">Services</a>
                    <a href="index.html#contact" class="text-xl font-semibold text-gray-700 hover:text-primary">Contact</a>
